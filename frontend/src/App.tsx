...
function App() {
   ...
   */
  const handleStart = async (source: string, threshold: number, spreadSplit: boolean, requireBothEyes: boolean) => {
    setStopError(null)
    setProgress(null)
    setResult(null)
    ...
    try {
      const response = await fetch('/api/start', {
        ...
        body: JSON.stringify({ source_folder: source, threshold, spread_split: spreadSplit, require_both_eyes: requireBothEyes }),
      })
